...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
	    ...
	    // EfficientDocument (module 2).
		    ...
		    //1. count the number of vowels in word (a, e, i, o, u, y) 				====>count ++
		    //2. if e is the last letter of the word and the word has another vowel ====>count--
		    //3. do not count diphthong or triphthong twice (au, oy, oo, iou)		====>count--
		
		int syllables_per_word = 0;
		...
		for (char c : cArray) {
			...
			if (c == 'e' && count==size-1 && syllables_per_word > 1) {
				syllables_per_word--;
			}
			count++;
		}
